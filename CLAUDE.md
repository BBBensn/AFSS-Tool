...
- Kurze Historie:
  ...
  - `v1.28.0` — neuer WSGI-Einstiegspunkt `afss/wsgi.py` (liest `AFSS_CONFIG_DIR`/`AFSS_DB_PATH`/
    `AFSS_SECRET_KEY` aus der Umgebung) fuer den Deploy unter `afss.bensn.me` (Hetzner-Server,
